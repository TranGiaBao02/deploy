...
let initWebRoutes = (app) => {
  ...
  router.get("/CRUDPage", homeController.getCRUDPage);
  ...
  router.post("/api/payment", paymentController.initiatePayment);
  router.post('/callback', paymentController.handleMoMoCallback);
  router.get("/api/payment-info", paymentController.getDoctorPriceInfo);

  router.post('/api/zalopay', paymentController.createZaloPayOrder);
  router.post("/api/payment/zalopay-callback", paymentController.handleZaloPayCallback);
